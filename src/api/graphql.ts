...
export type PlaceInfoFragment = {
  ...
  category: string
  id: string
} & { ' $fragmentName'?: 'PlaceInfoFragment' }
...
export const PlaceInfoFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'PlaceInfo' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Place' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'parkingAvailable' } },
          { kind: 'Field', name: { kind: 'Name', value: 'parkingCount' } },
          { kind: 'Field', name: { kind: 'Name', value: 'wheelChairRentable' } },
          { kind: 'Field', name: { kind: 'Name', value: 'elevatorAvailable' } },
          { kind: 'Field', name: { kind: 'Name', value: 'toiletAvailable' } },
          { kind: 'Field', name: { kind: 'Name', value: 'pathExists' } },
          { kind: 'Field', name: { kind: 'Name', value: 'pathDescription' } },
          { kind: 'Field', name: { kind: 'Name', value: 'latitude' } },
          { kind: 'Field', name: { kind: 'Name', value: 'longitude' } },
          { kind: 'Field', name: { kind: 'Name', value: 'etc' } },
          { kind: 'Field', name: { kind: 'Name', value: 'basicInfo' } },
...
} as unknown as DocumentNode<PlaceInfoFragment, unknown>
export const GetSearchListDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetSearchList' },
      variableDefinitions: [
        {
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'parkingAvailable' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'Boolean' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'wheelChairRentable' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'Boolean' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'elevatorAvailable' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'Boolean' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'toiletAvailable' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'Boolean' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'pathExists' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'Boolean' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'needCompanion' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'Boolean' } },
          },
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'coordinates' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'CoordinateInput' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            arguments: [
              ...
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'parkingAvailable' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'parkingAvailable' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'wheelChairRentable' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'wheelChairRentable' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'elevatorAvailable' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'elevatorAvailable' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'toiletAvailable' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'toiletAvailable' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'pathExists' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'pathExists' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'needCompanion' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'needCompanion' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'coordinates' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'coordinates' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            { kind: 'Field', name: { kind: 'Name', value: 'thumbnails' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'parkingAvailable' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'parkingCount' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'wheelChairRentable' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'elevatorAvailable' } },
                            ...
                            { kind: 'Field', name: { kind: 'Name', value: 'longitude' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'category' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'needCompanion' } },
...
} as unknown as DocumentNode<GetSearchListQuery, GetSearchListQueryVariables>
/** All built-in and custom scalars, mapped to their actual values */
export type Scalars = {
  ID: string
  String: string
...
export type PlacesConnectionKeySpecifier = (
  | 'edges'
  | 'pageInfo'
  | 'totalCount'
  | PlacesConnectionKeySpecifier
)[]
...
export type StrictTypedTypePolicies = {
  ...
  PlacesConnection?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PlacesConnectionKeySpecifier
      | (() => undefined | PlacesConnectionKeySpecifier)
