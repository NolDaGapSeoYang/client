...
export type GetCountQueryVariables = Exact<{
  PlaceCountInput: PlaceCountInput;
}>;


export type GetCountQuery = { __typename?: 'Query', placeCount: number };
...
export const GetCountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getCount"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"PlaceCountInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PlaceCountInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"placeCount"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"PlaceCountInput"}}}]}]}}]} as unknown as DocumentNode<GetCountQuery, GetCountQueryVariables>;
